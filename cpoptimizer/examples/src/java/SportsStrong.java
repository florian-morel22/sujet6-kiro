// ---------------------------------------------------------------*- Java -*-
// File: ./examples/src/java/SportsStrong.java
// --------------------------------------------------------------------------
...
public class SportsStrong {
    ...
    public static IloIntExpr Game(IloCP cp, IloIntExpr h, IloIntExpr a, int n) throws IloException {
