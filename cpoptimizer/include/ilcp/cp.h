...
public:
  ...
  enum SearchTypeBounds {
    ...
    LastSearchType = IterativeDiving
  };
  ...
  enum NumInfo {    
    ...
    IterativeDivingAverageIdleTime = 2031,  
    
    
    MultiPointIdleTimePercentage = 2032,  
    
    
    RestartIdleTimePercentage = 2033,  
    
    
    DepthFirstIdleTimePercentage = 2034,  
    
    
    EngineIdleTimePercentage = 2035,  
    
    
    IterativeDivingIdleTimePercentage = 2036, 
  ILC_MAX_NumInfo
                 };    
